...
# energy1 is a better predictor by including predictors toxic and green.
# According to the summary, metro isn't a significant variable when predicting energy
...
# There doesn't seem to be any significance to adding region to the model created energy1
# However, in model energy6, there seems to be some significance in the N. East region